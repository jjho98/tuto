...
function initModels(sequelize) {
  ...
  tutorial.belongsToMany(user, { as: 'user_id_users', through: taken, foreignKey: "tutorial_id", otherKey: "user_id" });
  tutorial.belongsToMany(user, { as: 'user_id_user_takings', through: taking, foreignKey: "tutorial_id", otherKey: "user_id" });
  user.belongsToMany(tutorial, { as: 'tutorial_id_tutorials', through: taken, foreignKey: "user_id", otherKey: "tutorial_id" });
  user.belongsToMany(tutorial, { as: 'tutorial_id_tutorial_takings', through: taking, foreignKey: "user_id", otherKey: "tutorial_id" });
  ...
  portfolioImage.belongsTo(portfolio, { as: "portfolio", foreignKey: "portfolio_id"});
  portfolio.hasMany(portfolioImage, { as: "portfolioImages", foreignKey: "portfolio_id"});
